...
## [14.1.1](https://github.com/ziren-patches/revm/compare/revm-inspector-v14.1.0...revm-inspector-v14.1.1) - 2025-12-04

### Other

- replace HashMap with fixed-size array for opcode counts in CountInspector ([#3203](https://github.com/ziren-patches/revm/pull/3203))
