...
## [10.1.0](https://github.com/ziren-patches/revm/compare/revme-v10.0.2...revme-v10.1.0) - 2025-12-04

### Added

- DatabaseCommitExt + increment_balances ([#3195](https://github.com/ziren-patches/revm/pull/3195))
- sort accounts by address in blockchaintest output ([#3182](https://github.com/ziren-patches/revm/pull/3182))
